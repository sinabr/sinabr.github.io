...
description: "I led Carnegie Mellon's work with the Model Hardware Standard in the research preview, building drivers and an orchestration layer so an AI agent could operate a liquid handler, plate reader, and robotic arm for serial-dilution dose-response experiments."
format:
  html:
    toc: true
    toc-depth: 2
...
MHS is a new standard for AI agents to safely operate physical equipment in scientific research and advanced manufacturing. In this limited research preview the specification is still provisional — not a general release — and it is not Claude-only: any MHS-compatible AI agent can use it. On our bench we ran a safe closed-loop agentic workflow within the bounds, interlocks, and emergency stops the devices declare.
...
Access to the preview is by application while the safety design is validated. CMU's work with MHS is featured in the [announcement](https://www.anthropic.com/news/model-hardware-standard-research-preview) under *Carnegie Mellon University: Determining dose-response curves through rapid automation*. School of Computer Science coverage is also on [LinkedIn](https://www.linkedin.com/feed/update/urn:li:ugcPost:7498829877215842304/?actorCompanyId=28172194) and [X](https://x.com/SCSatCMU/status/2093063825171853484).
