...
We used the [Model Hardware Standard (MHS)](https://www.anthropic.com/news/model-hardware-standard-research-preview) research preview (announced by Anthropic) to let an AI agent operate a liquid handler, a plate reader, a robotic arm, and monitoring cameras. Serial-dilution dose-response experiments ran about three times faster than before. I led this work on the CMU side: the AI orchestration and software integration that brought disconnected device interfaces into one system an agent could coordinate.

MHS is a new standard for AI agents to safely operate physical equipment in scientific research and advanced manufacturing. It is currently in a limited research preview. It is a provisional specification — not a general release — and is not Claude-only: MHS-compatible AI agents can use it. We used the preview to run a safe closed-loop agentic workflow on our instruments within device-declared safety bounds.
...
That integration tax is what this MHS deployment was built to cut.

## Closed-loop operation

On our bench, MHS let us run these experiments about **three times faster** by giving an AI agent a single way to operate the instruments. The CMU setup combines:
