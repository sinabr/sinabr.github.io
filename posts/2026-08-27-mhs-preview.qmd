---
title: "How we tested dose-response experiments with an AI agent using the Model Hardware Standard"
date: 2026-08-27
author: "Sina Barazandeh"
categories: [lab-automation, agents, mhs, cmu]
image: "../files/mhs-related-photo/instruments_1.png"
description: "I led Carnegie Mellon's participation in the Model Hardware Standard research preview, building drivers and an orchestration layer so an AI agent could operate a liquid handler, plate reader, and robotic arm for serial-dilution dose-response experiments."
format:
  html:
    toc: true
    toc-depth: 2
...
We used the [Model Hardware Standard (MHS)](https://www.anthropic.com/news/model-hardware-standard-research-preview) research preview to let an AI agent operate a liquid handler, a plate reader, a robotic arm, and monitoring cameras. Serial-dilution dose-response experiments ran about three times faster than before. I led this work on the CMU side: the AI orchestration and software integration that brought disconnected device interfaces into one system an agent could coordinate.

MHS is a new standard for AI agents to safely operate physical equipment in scientific research and advanced manufacturing. It is being co-developed by Anthropic, Arm, and HHMI Janelia Research Campus and is currently in a limited research preview. It is a provisional specification — not a general release, and not an Anthropic or Claude product. We participated in the preview to test how MHS-compatible agents operate our instruments within device-declared safety bounds.

The most rewarding part was watching that software leave the editor and come to life in a working physical laboratory.

::: {.mhs-video}
<iframe src="https://drive.google.com/file/d/1GaC_-bp70Zbpq_7aom55OYunS8fB1SzE/preview" title="CMU MHS research preview video" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
:::

<p class="mhs-video-note">The lab run above is from our MHS research preview work at CMU. If the player does not start immediately, click it once — or <a href="https://drive.google.com/file/d/1GaC_-bp70Zbpq_7aom55OYunS8fB1SzE/view?usp=drive_link" target="_blank" rel="noopener">open the video on Google Drive</a>.</p>

## The MHS research preview

Access during the preview is by application while the safety design is validated. CMU's deployment is featured in the [MHS announcement](https://www.anthropic.com/news/model-hardware-standard-research-preview) under *Carnegie Mellon University: Determining dose-response curves through rapid automation*. School of Computer Science coverage is also on [LinkedIn](https://www.linkedin.com/feed/update/urn:li:ugcPost:7498829877215842304/?actorCompanyId=28172194) and [X](https://x.com/SCSatCMU/status/2093063825171853484).
...
- an **Analytik Jena CyBio FeliX** liquid handler
- a **Thermo Scientific Varioskan LUX** plate reader
- a **Thermo Scientific Spinnaker** robotic arm
- monitoring cameras
...
MHS is model-agnostic. We used Claude as one MHS-compatible agent in this deployment, not as a requirement of the standard.

::: {layout-ncol=3}
![Thermo Scientific Spinnaker, a robotic arm designed to handle and transport microplates in automated laboratory workflows.](../files/mhs-related-photo/arm.jpg)

![Analytik Jena CyBio FeliX, a liquid handling instrument used to automate pipetting, sample transfer, and other routine workflows in biological laboratories.](../files/mhs-related-photo/felix-photo.jpg)

![Thermo Scientific Varioskan LUX plate reader, used to measure the optical signal from each well of a microplate. In this experiment, the reader quantifies absorbance so the system can determine how the measured response changes across the dilution series.](../files/mhs-related-photo/plate_reader.jpg)
:::

::: {.mhs-photo}
![CMU laboratory instruments: the Analytik Jena CyBio FeliX liquid handler for automated pipetting and liquid-transfer workflows (left), and the Thermo Scientific Varioskan LUX multimode plate reader for microplate-based absorbance, fluorescence, and luminescence measurements (right).](../files/mhs-related-photo/instruments_1.png)
:::

::: {.mhs-photo}
![Thermo Scientific Spinnaker robotic arm for automated microplate handling and transport (left), with monitoring cameras used to observe plate movement and system operation (center and right).](../files/mhs-related-photo/instruments_2.png)
:::
