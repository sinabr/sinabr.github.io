...
image: "../files/mhs-related-photo/instruments-1.webp"
description: "I led Carnegie Mellon's work using the Model Hardware Standard in the research preview, building drivers and an orchestration layer so an AI agent could operate a liquid handler, plate reader, robotic arm, and cameras for serial-dilution dose-response experiments."
format:
  html:
    toc: true
    toc-depth: 2
...
I built the drivers from scratch for each instrument, plus the orchestration layer that lets an agent run the full protocol within device-declared bounds. That work took about **eight hours**, compared with the weeks of per-instrument integration that motivated this work. The instruments keep running their native software; MHS sits on top. No extra automation stack required.
...
::: {.mhs-photo}
![CMU laboratory instruments: the CyBio FeliX liquid handler for automated pipetting and liquid-transfer workflows (left), and the Varioskan LUX multimode plate reader for microplate-based absorbance, fluorescence, and luminescence measurements (right).](../files/mhs-related-photo/instruments-1.webp)
:::

::: {.mhs-photo}
![Spinnaker robotic arm for automated microplate handling and transport (left), with monitoring cameras used to observe plate movement and system operation (center and right).](../files/mhs-related-photo/instruments-2.webp)
:::
...
::: {.mhs-photo}
![A 96-well plate arranged as a serial dilution, with the concentration decreasing step by step across the columns from 200 µg/mL to 0.20 µg/mL. This produces a broad, predictable concentration range that can be measured to build a dose-response curve.](../files/mhs-related-photo/serial-dilution-plate-map.webp)
:::
...
This was a team effort. I am grateful to **Arth Banka**, **Gün Kaynar**, **Jiayi Li**, and **Peneeta Wojcik** for their work, and to my advisor **Jose Lugo-Martinez**, **Carl Kingsford**, and **Joshua Kangas** for their guidance.
