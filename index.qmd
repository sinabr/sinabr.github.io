...
- **Lab Automation / MHS:** Led CMU's participation in the Model Hardware Standard research preview, building drivers and orchestration so an AI agent could operate a liquid handler, plate reader, and robotic arm
...
- **Aug 2026:** Carnegie Mellon is featured in the [Model Hardware Standard (MHS) research preview](https://www.anthropic.com/news/model-hardware-standard-research-preview) (announced by Anthropic). I led CMU's work using MHS to let an AI agent operate a liquid handler, plate reader, robotic arm, and cameras for serial-dilution dose-response experiments ~3× faster. [Read the post.](posts/2026-08-27-mhs-preview.qmd) Also covered by [CMU SCS on LinkedIn](https://www.linkedin.com/feed/update/urn:li:ugcPost:7498829877215842304/?actorCompanyId=28172194) and [X](https://x.com/SCSatCMU/status/2093063825171853484).
